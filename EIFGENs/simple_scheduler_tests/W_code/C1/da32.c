...
extern EIF_TYPED_VALUE F32_736(EIF_REFERENCE);
extern EIF_TYPED_VALUE F32_737(EIF_REFERENCE);
extern EIF_TYPED_VALUE F32_738(EIF_REFERENCE);
extern EIF_TYPED_VALUE F32_739(EIF_REFERENCE);
...
{
	GTCX
	RTOTC (F32_735,809,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F32_736)
EIF_TYPED_VALUE F32_736 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 31, Current, 0, 0, 809);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(31, Current, 809);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {353,0xFF01,266,0xFFFF};
		EIF_TYPE typres0;
...
RTOID (F32_737)
EIF_TYPED_VALUE F32_737 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 31, Current, 0, 0, 810);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(31, Current, 810);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800015E, 0,0); /* Result */
...
RTOID (F32_738)
EIF_TYPED_VALUE F32_738 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 31, Current, 0, 0, 811);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(31, Current, 811);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800015E, 0,0); /* Result */
...
RTOID (F32_739)
EIF_TYPED_VALUE F32_739 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 31, Current, 0, 0, 812);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(31, Current, 812);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800015E, 0,0); /* Result */
...
{
	GTCX
	RTOTC (F32_740,814,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F32_741,815,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F32_742,816,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
