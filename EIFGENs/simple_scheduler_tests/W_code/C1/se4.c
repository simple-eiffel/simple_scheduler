...
extern void F4_6924(EIF_REFERENCE, int);
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(58, dtype)) = (EIF_INTEGER_32) arg1;
	...
	RTHOOK(4);
	RTDBGAA(Current, dtype, 63, 0xF80001B8, 0); /* mismatches_by_name */
	...
	*(EIF_REFERENCE *)(Current + RTWA(63, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(5);
	RTDBGAA(Current, dtype, 64, 0xF80001BE, 0); /* mismatches_by_stored_position */
...
body:;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,0xFFF9,9,218,0xFF01,266,0xFF01,266,223,223,223,223,253,253,253,0xFFFF};
		EIF_TYPE typres0;
	...
	ur1 = RTCCL(loc1);
	ur2 = RTCCL(arg4);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(3025, "put", tr1))(tr1, ur1x, ur2x);
	RTHOOK(9);
...
void F4_6924 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 3, Current, 0, 6923);
	RTSA(dtype);
	RTME(dtype, 0);
