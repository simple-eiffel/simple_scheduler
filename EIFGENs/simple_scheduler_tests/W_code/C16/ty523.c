...
extern EIF_TYPED_VALUE F523_3315(EIF_REFERENCE);
...
EIF_TYPED_VALUE F523_3315 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 522, Current, 0, 0, 3352);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(522, Current, 3352);
	RTIV(Current, RTAL);
