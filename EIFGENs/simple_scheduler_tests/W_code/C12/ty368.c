...
extern EIF_TYPED_VALUE F368_3315(EIF_REFERENCE);
...
EIF_TYPED_VALUE F368_3315 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 367, Current, 0, 0, 3349);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(367, Current, 3349);
	RTIV(Current, RTAL);
