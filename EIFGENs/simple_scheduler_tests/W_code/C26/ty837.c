...
extern EIF_TYPED_VALUE F837_3315(EIF_REFERENCE);
...
EIF_TYPED_VALUE F837_3315 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 836, Current, 0, 0, 3360);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(836, Current, 3360);
	RTIV(Current, RTAL);
