...
extern EIF_TYPED_VALUE F878_3486(EIF_REFERENCE);
extern void F878_6970(EIF_REFERENCE, int);
...
/* {ACTIVE}.replaceable */
EIF_TYPED_VALUE F878_3486 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 877, Current, 0, 0, 4791);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(877, Current, 4791);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ACTIVE}._invariant */
void F878_6970 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 877, Current, 0, 6969);
	RTSA(dtype);
	RTME(dtype, 0);
