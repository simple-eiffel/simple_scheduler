...
extern EIF_TYPED_VALUE F873_3315(EIF_REFERENCE);
...
EIF_TYPED_VALUE F873_3315 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 872, Current, 0, 0, 3361);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(872, Current, 3361);
	RTIV(Current, RTAL);
