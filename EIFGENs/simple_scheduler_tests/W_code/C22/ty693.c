...
extern EIF_TYPED_VALUE F693_3315(EIF_REFERENCE);
...
EIF_TYPED_VALUE F693_3315 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 692, Current, 0, 0, 3356);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(692, Current, 3356);
	RTIV(Current, RTAL);
