...
extern EIF_TYPED_VALUE F698_3486(EIF_REFERENCE);
extern void F698_6970(EIF_REFERENCE, int);
...
/* {ACTIVE}.replaceable */
EIF_TYPED_VALUE F698_3486 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 697, Current, 0, 0, 4781);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(697, Current, 4781);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ACTIVE}._invariant */
void F698_6970 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 697, Current, 0, 6969);
	RTSA(dtype);
	RTME(dtype, 0);
