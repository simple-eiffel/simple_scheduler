...
extern EIF_TYPED_VALUE F957_3472(EIF_REFERENCE);
...
EIF_TYPED_VALUE F957_3472 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 956, Current, 0, 0, 4728);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(956, Current, 4728);
	RTIV(Current, RTAL);
	RTHOOK(1);
