...
extern EIF_TYPED_VALUE F404_3315(EIF_REFERENCE);
...
EIF_TYPED_VALUE F404_3315 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 403, Current, 0, 0, 3350);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(403, Current, 3350);
	RTIV(Current, RTAL);
