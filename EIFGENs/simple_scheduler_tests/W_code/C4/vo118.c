...
extern EIF_TYPED_VALUE F118_1577(EIF_REFERENCE);
extern EIF_TYPED_VALUE F118_1578(EIF_REFERENCE);
...
EIF_TYPED_VALUE F118_1577 (EIF_REFERENCE Current)
{
	GTCX
...
RTOID (F118_1578)
EIF_TYPED_VALUE F118_1578 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 117, Current, 0, 0, 1594);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(117, Current, 1594);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
