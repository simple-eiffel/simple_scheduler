...
extern void F493_6970(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F493_3486 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 492, Current, 0, 0, 4771);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(492, Current, 4771);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ACTIVE}._invariant */
void F493_6970 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 492, Current, 0, 6969);
	RTSA(dtype);
	RTME(dtype, 0);
