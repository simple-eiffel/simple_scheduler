...
extern EIF_TYPED_VALUE F488_3315(EIF_REFERENCE);
...
EIF_TYPED_VALUE F488_3315 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 487, Current, 0, 0, 3351);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(487, Current, 3351);
	RTIV(Current, RTAL);
