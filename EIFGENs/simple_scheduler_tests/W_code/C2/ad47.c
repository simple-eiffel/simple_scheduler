...
extern EIF_TYPED_VALUE F47_930(EIF_REFERENCE);extern EIF_INTEGER_32 en_addrinfo_af_inet();

extern EIF_TYPED_VALUE F47_931(EIF_REFERENCE);extern EIF_INTEGER_32 en_addrinfo_af_inet6();
...
EIF_TYPED_VALUE F47_930 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 46, Current, 0, 0, 969);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
EIF_TYPED_VALUE F47_931 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 46, Current, 0, 0, 970);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
