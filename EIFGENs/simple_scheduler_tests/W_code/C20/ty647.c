...
extern EIF_TYPED_VALUE F647_3315(EIF_REFERENCE);
...
EIF_TYPED_VALUE F647_3315 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 646, Current, 0, 0, 3355);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(646, Current, 3355);
	RTIV(Current, RTAL);
