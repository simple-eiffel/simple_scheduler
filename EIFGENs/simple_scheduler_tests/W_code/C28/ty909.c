...
extern EIF_TYPED_VALUE F909_3315(EIF_REFERENCE);
...
EIF_TYPED_VALUE F909_3315 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 908, Current, 0, 0, 3362);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(908, Current, 3362);
	RTIV(Current, RTAL);
