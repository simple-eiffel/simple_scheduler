...
extern EIF_TYPED_VALUE F572_3315(EIF_REFERENCE);
...
EIF_TYPED_VALUE F572_3315 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 571, Current, 0, 0, 3353);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(571, Current, 3353);
	RTIV(Current, RTAL);
