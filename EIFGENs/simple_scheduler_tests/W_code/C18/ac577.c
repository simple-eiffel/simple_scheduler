...
extern void F577_6970(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F577_3486 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 576, Current, 0, 0, 4775);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(576, Current, 4775);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ACTIVE}._invariant */
void F577_6970 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 576, Current, 0, 6969);
	RTSA(dtype);
	RTME(dtype, 0);
