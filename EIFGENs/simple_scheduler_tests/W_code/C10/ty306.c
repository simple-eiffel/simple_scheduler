...
extern EIF_TYPED_VALUE F306_3315(EIF_REFERENCE);
...
EIF_TYPED_VALUE F306_3315 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 305, Current, 0, 0, 3348);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(305, Current, 3348);
	RTIV(Current, RTAL);
