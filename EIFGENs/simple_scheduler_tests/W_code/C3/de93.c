...
extern EIF_TYPED_VALUE F93_1516(EIF_REFERENCE);
...
EIF_TYPED_VALUE F93_1516 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 92, Current, 0, 0, 1532);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 92, Current, 0, 0, 1533);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
