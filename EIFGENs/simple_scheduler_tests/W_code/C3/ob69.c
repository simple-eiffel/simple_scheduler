...
extern EIF_TYPED_VALUE F69_1270(EIF_REFERENCE);
...
EIF_TYPED_VALUE F69_1270 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 68, Current, 0, 0, 1297);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(68, Current, 1297);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80002A5, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,677,0xFF01,0,0xFFFF};
		EIF_TYPE typres0;
