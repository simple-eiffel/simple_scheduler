...
extern EIF_TYPED_VALUE F612_3486(EIF_REFERENCE);
extern void F612_6970(EIF_REFERENCE, int);
...
/* {ACTIVE}.replaceable */
EIF_TYPED_VALUE F612_3486 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 611, Current, 0, 0, 4777);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(611, Current, 4777);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ACTIVE}._invariant */
void F612_6970 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 611, Current, 0, 6969);
	RTSA(dtype);
	RTME(dtype, 0);
