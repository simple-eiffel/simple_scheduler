...
extern EIF_TYPED_VALUE F252_5799(EIF_REFERENCE);
...
EIF_TYPED_VALUE F252_5798 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 251, Current, 0, 0, 12679);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(251, Current, 12679);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F252_5799 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 251, Current, 0, 0, 12680);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(251, Current, 12680);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x1C000000, 1,0); /* Result */
	tw1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4437, 249))(Current)).it_c4);
