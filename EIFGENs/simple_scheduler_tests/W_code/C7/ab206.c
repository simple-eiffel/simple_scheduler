...
extern EIF_TYPED_VALUE F206_4231(EIF_REFERENCE);
extern void F206_6988(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F206_4231 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 205, Current, 0, 0, 7196);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(205, Current, 7196);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F206_6988 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 205, Current, 0, 6987);
	RTSA(dtype);
	RTME(dtype, 0);
